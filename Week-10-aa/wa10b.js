...
async.eachSeries(addressesForDb, function(value, callback) {
    ...
    var thisQuery = "INSERT INTO aa_meeting_database(address,lat,long,zipCode,zone,venue,roomDetail,directionDetail,groupName,wheelchairAccess,miscDetails,day,trueStartTime,trueEndTime,meetingType,specialInerest) VALUES ($$" + value.thisMeeting.address + "$$, $$" + value.latLong.lat + "$$, $$" + value.latLong.long + "$$, $$" + value.thisMeeting.zipCode + "$$, $$" + value.thisMeeting.zone + "$$, $$" + value.thisMeeting.venue + "$$, $$" + value.thisMeeting.roomDetail + "$$, $$" + value.thisMeeting.directionDetail + "$$, $$" + value.thisMeeting.groupName + "$$, $$" + value.thisMeeting.wheelchairAccess + "$$, $$" + value.thisMeeting.miscDetails + "$$, $$" + value.thisMeeting.meetingDetails.day[0] + "$$, $$" + value.thisMeeting.meetingDetails.trueStartTime[0] + "$$, $$" + value.thisMeeting.meetingDetails.trueEndTime[0] + "$$, $$" + value.thisMeeting.meetingDetails.meetingType[0] + "$$, $$" + value.thisMeeting.meetingDetails.specialInerest[0] + "$$);";
